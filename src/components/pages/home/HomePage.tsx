...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 pb-10">
      ...
      <p className="text-2xl text-center">API used:  <Link to={'https://freecurrencyapi.com/'} target="_blank" rel="noopener noreferrer" className="link lg:link-hover">https://freecurrencyapi.com/</Link></p>
      <CarouselInfo />
